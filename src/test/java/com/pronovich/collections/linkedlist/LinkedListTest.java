...
public class LinkedListTest {
    ...
    private List<Integer> testInstance;

    @Before
    public void setUp() {
        testInstance = new LinkedList<>();
        testInstance.add(3);
        testInstance.add(5);
        testInstance.add(8);
        testInstance.add(11);
    ...
    @Test
    public void correctSizeAfterAdd() {
        assertEquals("Size doesn't match", 4, testInstance.size());
    }

    @Test
    public void toArrayLength() {
        assertEquals("Length of Array incorrect", 4, testInstance.toArray().length);
    }

    @Test
    public void containsTrue() {
        assertTrue("The list contains the object", testInstance.contains(8));
    }

    @Test
    public void containsFalse() {
        assertFalse("The list doesn't contain the object", testInstance.contains(33));
    }
    ...
    public void testSet() {
        ...
        listIterator.next();
        listIterator.set(2);
        Integer res = testInstance.get(0);
